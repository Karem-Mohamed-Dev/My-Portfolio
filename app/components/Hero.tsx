...
const Hero = () => {
  return (
    <section id='home' className='border-b-[1px] border-gray-600'>
      <div className="h-screen py-28 px-5 container mx-auto flex flex-row-reverse items-center justify-around">
        <Image
          src={img}
          alt='Karim'
          width={500}
        ...
        <div className="gap-5 flex flex-col">
          ...
          <div className="text-right">
            <h2 className='text-6xl text-left'>Talk is sheap. <br /> Show me the <span className='text-main font-medium head-underline'>&#60;/Code&#62;</span></h2>
            <span className='italic text-sm text-gray-400'>~ Linus Torvalds</span>
          </div>
          <p className='text-xl text-gray-300'>A Great Design Needs  Great Devloper To Execute It.</p>
