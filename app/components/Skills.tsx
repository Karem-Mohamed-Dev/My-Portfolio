...
const Skills = () => {
  return (
    <section id='skills' className='flex flex-col justify-between items-center bg-white text-black min-h-screen py-28 text-center'>
      ...
      <a href='https://drive.google.com/file/d/1MhqHYi8ZXIo8wiiPiBKUcHBa01m15AdD/view?usp=drive_link' target='_blank' className='border-[2px] border-black w-fit py-3 px-6 font-semibold rounded hover:bg-black hover:text-white duration-300'>View My Resume</a>
    </section>
  )
}
